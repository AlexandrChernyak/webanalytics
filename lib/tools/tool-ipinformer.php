<?php
 /** Модуль управления инструментом `информер ip адреса`
 * @author [Eugene]
 * @copyright 2011
 ...
 */
 ...
 class w_toolitem_ipinformer extends w_toolitem_noajax_method {
  /** тип информеров */
  const CUR_INFORMER_TYPE = 2; //информер ip 			
  protected
   $result,
   $inf;
