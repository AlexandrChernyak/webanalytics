 ...
 <script type="text/javascript"> 
  ...
  function InitializeList() {    	
   ...
   $(list_ids['link']).click(function(){	
	var hrefdata =  prompt ("Enter the address of the link!", "http://" );
   ...
   $(GetID('ml')).click(function(){ 
	var pdata =  prompt("Set margin left (without px)!", "5" );
   ...
   <td colspan="1" valign="top" align="left">
    ...
    <tr>
	 <td align="left" valign="top" class="buttons_head">
	  <span id="qbo_{$ident}" style="margin-left: 0px" title="Bold (Ctrl+B)">
	  <img src="{$smarty.const.W_SITEPATH}img/ico/formats/bold.gif"></span>
	  <span id="qital_{$ident}" title="Italic (Ctrl+I)">
	  <img src="{$smarty.const.W_SITEPATH}img/ico/formats/italic.gif"></span>
	  <span id="qunder_{$ident}" title="Underline (Ctrl+U)">
      ...
      <span id="qpre_{$ident}" title="Tag <pre>">
	 ...
	 <td width="20px" align="right" valign="top" class="buttons_head">
	  ...
	  <tr>
	   <td>
	    <span style="margin-left: 0px; height: 9px" id="qresup_{$ident}" title="Decrease editor (Ctrl+Up)">
	  ...
	  <tr>
	   <td>
	    <span style="margin: 2px 0px 0px 0px; height: 9px" id="qresdw_{$ident}" title="Increase editor (Ctrl+Down)">
