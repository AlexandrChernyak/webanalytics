...
<div style="margin-top: 20px">
 ...
 {if !$blist}<div style="margin-left: 4px">No active banners!</div>{else}
  {foreach from=$blist key=rname item=val name=val}
   ...
   <div class="analisislabelid" style="margin-top: 15px; background: #F4F4F4"><strong>{$rname}</strong><label style="color: #000000; margin-left: 6px">[ <a style="font-size: 95%" href="javascript:" onclick="ShHdBlElementA(this, 'block_{$ref.iditem}')">Hide</a> ]</label></div>
