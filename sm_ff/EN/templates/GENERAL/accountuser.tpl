<div>
 ...
 {/literal}
 <div class="head_title" style="background: #F8F8F8; padding: 2px">General Information</div>
 ...
 <div class="head_title" style="margin-top: 15px; background: #F8F8F8; padding: 2px">Financial Information</div>
 <div style="margin-top: 10px; margin-left: 7px">
 <span style="width: 100%">
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
 <tr>
 ...
 <div class="head_title" style="margin-top: 15px; background: #F8F8F8; padding: 2px">Referral system</div>
 <div style="margin-top: 10px; margin-left: 7px">
 <span style="width: 100%">
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
 <tr>
 ...
 <div class="head_title" style="margin-top: 15px; background: #F8F8F8; padding: 2px">Mail</div>
 <div style="margin-top: 10px; margin-left: 7px">
 <span style="width: 100%">
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
 <tr>
