<!-- analisys begin -->
  ...
  <div style="margin-top: 30px">
   ...
   <div class="apdates_title">
    <a href="{$smarty.const.W_SITEPATH}tools/" class="upd_title">The most popular tools</a>
   </div>
  ...
  <div style="margin-top: 26px">
   ...
   <div class="apdates_title"><a href="{$smarty.const.W_SITEPATH}news/1/" class="upd_title">Site News</a></div>
