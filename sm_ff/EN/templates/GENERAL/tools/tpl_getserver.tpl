...
<div style="margin-top: 5px">
 ...
 This tool will help you determine the server on which the specified site.
 {/if}
 ...
 <form method="post" name="tollform" id="toolform" onsubmit="return PrepereToSend(this)">
  <div class="typelabel"><label id="red">*</label> The list of sites or IP <label class="prep_label_analisys">(example: <a href="javascript:" onclick="DoSetDefUrl('urls')">{$smarty.const.W_HOSTMYSITE}</a>, or <a href="javascript:" onclick="ClearVal('urls')">clean</a> list)</label>{if isset($tool_object)}, &nbsp;No more: {$tool_object->GetLimitCount()}{/if}</div>
  <div class="typelabel">  
 ...
 {if $smarty.post.doactiontool == 'do' && isset($tool_object)}
  ...
  {else}
   ...
   <tr>
	...
	<td class="h_td" valign="center" align="right" width="120px">IP Site</td>		
	<td class="h_td2" valign="center" align="center"><label style="margin-right: 4px">Site Server</label></td>
   </tr>   	
