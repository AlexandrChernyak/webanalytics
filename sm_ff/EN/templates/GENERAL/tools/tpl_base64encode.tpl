...
<div style="margin-top: 5px">
 ...
 This tool will help you to perform encoding \ de coding lines in base64 encryption.
 {/if}
 ...
 <script type="text/javascript">
  function PrepereToSend(th) {
   if (trim(th.source.value) == '') {
	alert('Enter the text to analyze!');
	th.source.focus();
	return false;
   }
 ...
 <form method="post" name="tollform" id="toolform" onsubmit="return PrepereToSend(this)">
  ...
  <div class="typelabel">
  Encoding/decoding in charset (empty: UTF-8)
  </div>
  <div class="typelabel">
   <input type="text" value="{$CONTROL_OBJ->GetPostElement('charsetuse', 'doactiontool', 'do', 'UTF-8')}" style="width: 320px" class="inpt" name="charsetuse" id="charsetuse">
  </div>
