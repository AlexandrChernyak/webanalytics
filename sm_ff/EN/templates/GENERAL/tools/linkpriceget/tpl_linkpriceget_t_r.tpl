...
<table width="96%" cellpadding="0" cellspacing="0" border="0" id="tableresultsourceid">
 ...
 <tr>
  ...
  <label style="margin-left: 4px;">Host</label><label class="bgshort">&nbsp;</label>
  </th>
  
  <th class="h_td" valign="center" align="left" width="120px">
  <label style="margin-left: 4px;">LI 1</label><label class="bgshort">&nbsp;</label>
  </th>
  
  {if $smarty.post.uv2}
  <th class="h_td" valign="center" align="left" width="120px">
  <label style="margin-left: 4px;">LI 2</label><label class="bgshort">&nbsp;</label>
  </th>
  {/if}
  	
  {if $smarty.post.uv3}	
  <th class="h_td2" valign="center" align="left" width="120px">
  <label style="margin-left: 4px;">LI 3</label><label class="bgshort">&nbsp;</label>
  </th>
  {/if}
 </tr>   	
 </thead>
