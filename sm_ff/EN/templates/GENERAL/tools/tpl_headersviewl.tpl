...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  This tool will help you browse through http header to the request selected sites (URL).
  {/if}
...
<div class="typelabel">
   ...
   <input type="checkbox" name="followredirect" id="followredirect"><label for="followredirect" style="cursor: pointer"> Follow redirects</label>
</div>
