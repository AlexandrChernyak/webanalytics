...
{else}
 ...
 function ActionToExportURLElements() { 
  var count = GetSelectedCount();
  if (!count.selected) { return alert('Select Sites for Export!'); } 
  var queryurl = GetSelectedURLlist();
  if (!queryurl) { return alert('Not defined list of sites for Export!'); }
  if (!confirm('Are you sure you want to export the selected sites?')) { return false; } 
 ...
 <span class="blockmenuitemshead" id="statusitemblock">
  <ul>
   ...
   <li class="blockitemsbody" style="left: -6px">	  
    ...
    <div class="divblocked"><a id="quicklabelexport" href="javascript:" class="export">Export to .CSV</a></div>
