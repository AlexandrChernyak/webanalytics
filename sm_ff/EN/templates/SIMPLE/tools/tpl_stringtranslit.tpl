...
<div style="margin-top: 5px">
 ...
 his tool will help you translate the text in transliteration and back.
 <br /><br /><br /><br /><br />
 The transformation occurs in the transliteration scheme:<br />
...
<tr>
 ...
 <form method="post" name="tollform" id="toolform" onsubmit="return PrepereToSend(this)">
  ...
  <div class="typelabel">
   <input type="checkbox" {if $CONTROL_OBJ->CheckPostValue('back')}checked="checked" {/if}style="cursor: pointer" name="back" id="back"><label for="back" style="cursor: pointer">&nbsp;Translated from transliteration</label>
  </div>
