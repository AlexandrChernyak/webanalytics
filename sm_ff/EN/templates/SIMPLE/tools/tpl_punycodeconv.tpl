...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  This tool will help you to perform conversion of the Cyrillic domain on the source and to a coded form.
  {/if}
 ...
 <script type="text/javascript">  
  ...
  var PathRequstAction = PathHost + 'tools/punycodeconv/';
 ...
 {/literal}
<div class="typelabel"><label id="red">*</label> List of sites (any form) <label class="prep_label_analisys">(example: <a href="javascript:" onclick="DoSetDefUrl('urls')">президент.рф</a>, or <a href="javascript:" onclick="ClearVal('urls')">clean</a> list)</label>{if isset($tool_object) && !$tool_object->IsNoLimitTool()}<span id="paysourcefornolimit">
