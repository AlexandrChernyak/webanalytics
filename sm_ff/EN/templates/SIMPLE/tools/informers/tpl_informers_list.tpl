...
<div style="margin-top: 5px">
 ...
 <a style="font-size: 95%" href="javascript:" onclick="ShHdBlElementL(this, 'blockL{$val.section.iditem}')">Hide</a>
 ]</label>
 </div>	  
 <div style="margin-top: 12px; width: 95%; padding-left: 6px" id="blockL{$val.section.iditem}">
  {if !$val.informers}
   <div style="margin-left: 4px">Informers not found!</div>
  {else}
			  ...
			  <td valign="center" align="left" style="padding: 3px">
			   <label for="imgid{$val.informers[tdindex][trindex].iditem}" style="cursor: pointer">
				...
				<div style="margin-top: 4px" id="seldiv{$val.informers[tdindex][trindex].iditem}" title="#000000">
				 <a href="javascript:" id="selcolor{$val.informers[tdindex][trindex].iditem}" title="{$val.informers[tdindex][trindex].iditem}">Choose color</a>
				</div>
