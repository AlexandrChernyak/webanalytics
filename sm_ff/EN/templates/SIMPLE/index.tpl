<!-- analisys begin -->
  ...
  <tr>
	...
	<span class="prep_label_analisys">
	 Example: <a href="javascript:" onclick="$('#url').val('{$smarty.const.W_HOSTMYSITE}');">{$smarty.const.W_HOSTMYSITE}</a>
	</span>
	</td>
  ...
  <div style="margin-top: 30px">
   ...
   <div class="apdates_title">
    <a href="{$smarty.const.W_SITEPATH}tools/" class="black" style="font-weight: bold; text-decoration: none;">The most popular tools</a>
   </div>
   ...
   <!-- featured tools list END -->
	...
	<td valign="top" align="left">
	 ...
	 <div class="leftmenudwblockupdates">
      <div>
	   <a class="black" href="{$smarty.const.W_SITEPATH}updates/" style="font-weight: bold; text-decoration: none;">Updates search engine</a>
	  </div>
  ...
  <div style="margin-top: 26px">  
   ...
   <div style="margin-top: 26px"><a href="{$smarty.const.W_SITEPATH}news/1/" class="black" style="font-weight: bold; text-decoration: none;">Site News</a></div>
   ...
   <div style="margin-top: 20px"><a href="{$smarty.const.W_SITEPATH}news/2/" class="black" style="font-weight: bold; text-decoration: none;">Internet News</a></div>
   <div style="margin-top: 4px">
