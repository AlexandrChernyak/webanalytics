...
*}
<!-- vitrina links begin -->
<div><a class="black" href="{$smarty.const.W_SITEPATH}vitrinalinks/" style="font-weight: bold; text-decoration: none;">Showcase Links</a><span style="margin-left: 10px">[<a href="{$smarty.const.W_SITEPATH}vitrinalinks/new=1" class="black" style="margin: 0px 2px 0 2px; font-size: 95%">Add</a>]</span></div> 
