...
<div style="margin-top: 4px">
 ...
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
   <tr>
    <td class="h_th1" valign="center" align="center"><label id="red">Y</label>andex CY</td>
	<td class="h_td" valign="center" align="center"><label id="red">Y</label>andex.Search</td>	
	<td class="h_td" valign="center" align="center"><label id="red">Y</label>andex.Catalog</td>	
