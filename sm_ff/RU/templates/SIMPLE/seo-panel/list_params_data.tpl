...
*}
   <tr id="urllisthead">
    ...
    <th align="center" valign="center" width="10px" id="thimagetableall" style="border: none">	
	 <img src="{$smarty.const.W_SITEPATH}css/panel/img/urlmoveobj.png" width="8" height="16" align='absmiddle' title="Переместить сайт">	
	</th>
    ...
    <th align="center" valign="center" width="22px" id="thimagetableall">	
	 <img src="{$smarty.const.W_SITEPATH}css/panel/img/pictures_2.png" width="16" height="16" align='absmiddle' title="Иконка сайта">	
	</th>
