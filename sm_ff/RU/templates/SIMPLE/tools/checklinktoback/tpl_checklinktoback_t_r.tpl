{* таблица результата обработки проверки ссылки на сайт *}
<div>
{literal}
 <style type="text/css">
  .h_th1, .h_td, .h_td2 { 
...
<table width="96%" cellpadding="0" cellspacing="0" border="0" id="tableresultsourceid">
 ...
 <tr>
  ...
  <th class="h_td2" valign="center" align="left" width="100px">
  <label style="margin-left: 4px;">Ссылка</label><label class="bgshort">&nbsp;</label>
  </th>
 </tr>   	
 </thead>
 
 <tbody>{include file="tools/checklinktoback/tpl_checklinktoback_t_r_add_row.tpl"}</tbody>
