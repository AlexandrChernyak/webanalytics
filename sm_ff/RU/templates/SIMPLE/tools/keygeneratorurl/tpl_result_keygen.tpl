{* результат обработки генератора ключевых слов *}
  ...
  {else}
   {if $tool_object->GetResult()}
	...
	{/literal}
	<div style="margin-bottom: 7px"><b>Информация о тексте:</b></div>
    ...
    <div style="margin-top: 18px; width: 96%">
     <div style="margin-top: 10px"><b style="color: #969696">Результат</b></div>
	...
	<b>Слова списком подробнее</b>
	<label style="color: #000000; margin-left: 6px">[
	  <a style="font-size: 95%" href="javascript:" onclick="ShHdBlElement(this, 'wordsblocksource')">Скрыть</a>]</label>
	</div>
	<div style="margin-top: 12px; width: 95%; padding-left: 6px" id="wordsblocksource">
	 {if !$tool_object->GetResult('wordslist')}
	  <div style="margin-left: 4px; color: #FF0000">Не удалось обнаружить текст для обработки!</div>
	 {else}	  
	  <span style="width: 100%">
