...
<div style="margin-top: 5px">
 ...
 Данный инструмент поможет Вам Выполнить генерацию `потенциальных` ключевых слов для Вашего сайта, взяв за основу указанный Вами текст. Будут выбраны наиболее весомые слова текста.
 {/if}
 ...
 <form method="post" name="tollform" id="toolform" onsubmit="return PrepereToSend(this)">
  <div class="typelabel"><label id="red">*</label> Текст для анализа 
