...
<table width="96%" cellpadding="0" cellspacing="0" border="0" id="tableresultsourceid">
 ...
 <tr>
  ...
  <label style="margin-right: 4px;">Посетителей по LI</label><label class="bgshort">&nbsp;</label>
  </th>
 </tr>   	
 </thead>
 
 <tbody>{include file="tools/massvischeck/tpl_massvischeck_t_r_add_row.tpl"}</tbody>
