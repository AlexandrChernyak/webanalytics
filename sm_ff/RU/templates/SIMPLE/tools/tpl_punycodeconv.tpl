...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  Данный инструмент поможет Вам выполнить конвертацию кириллического домена в исходный и в закодированный вид.
  {/if}
 ...
 {/literal}
<div class="typelabel"><label id="red">*</label> Список сайтов (любая форма) <label class="prep_label_analisys">(пример: <a href="javascript:" onclick="DoSetDefUrl('urls')">президент.рф</a>, или <a href="javascript:" onclick="ClearVal('urls')">очистить</a> список)</label>{if isset($tool_object) && !$tool_object->IsNoLimitTool()}<span id="paysourcefornolimit">
