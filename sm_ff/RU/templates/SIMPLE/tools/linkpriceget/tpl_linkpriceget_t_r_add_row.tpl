...
<tr onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">
 ...
 <td class="sth1" valign="center" align="left" style="border-left: 1px solid #E3E4E8">
  <label style="margin-left: 4px">
   ...
   ?
   {else}  
    {$tool_object->CorrectURLLink($tool_object->GetResultValue('host'), 50)}&nbsp;<a title="Перейти на сайт (откроется в новом окне)" href="{$tool_object->CorrectLinkToProtocol($tool_object->GetResultValue('host'))}" target="_blank"><img src="{$smarty.const.W_SITEPATH}img/items/target_link.png"></a>
   {/if}  
  </label>	    
 </td>
 ...
 {if $smarty.post.uv3}
 <td class="sth1" valign="center" align="left" style="border-right: 1px solid #E3E4E8; width: 120px">
  <label style="margin-left: 4px">
   {if $tool_object->GetResultValue('host')}
