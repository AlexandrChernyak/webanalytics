...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  Данный инструмент поможет Вам извлечь все ссылки с указанных web страниц по указанному критерию.
  {/if}
 ...
 <script type="text/javascript">  
  ...
  function ActionProcessStart(th) { 
   ...
   if (!document.getElementById('inside').checked && !document.getElementById('outside').checked && 
    ...
    alert('Выберите хотя бы один из типов ссылок для извлечения!');
	return false;		
   }	  	
   //begin	
   id_count_value = 0;
...
<div class="typelabel">  
  ...
  <div class="typelabel">
   <input type="checkbox" style="cursor: pointer" name="asoriginal" id="asoriginal"><label for="asoriginal" style="cursor: pointer">&nbsp;В оригинальном варианте (не приводить к: http://host/ссылка)</label>
  </div>

  <div class="typelabel">
   <input type="checkbox" checked="checked" style="cursor: pointer" name="inside" id="inside"><label for="inside" style="cursor: pointer">&nbsp;Взять внутренние ссылки</label>
  </div>
  
  <div class="typelabel">
   <input type="checkbox" checked="checked" style="cursor: pointer" name="outside" id="outside"><label for="outside" style="cursor: pointer">&nbsp;Взять внешние ссылки</label>
  </div>
  
  <div class="typelabel">
   <input type="checkbox" checked="checked" style="cursor: pointer" name="subdom" id="subdom"><label for="subdom" style="cursor: pointer">&nbsp;Взять ссылки на поддомены</label>
  </div>
