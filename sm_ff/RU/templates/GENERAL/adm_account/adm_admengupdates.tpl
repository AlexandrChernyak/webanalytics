...
<div>
<a href="{$smarty.const.W_SITEPATH}account/admengupdates&new=1"{if $smarty.get.new} style="color: #000000"{/if}>Добавить апдейты</a> | {if $smarty.get.new}<a href="{$smarty.const.W_SITEPATH}account/admengupdates/">Все апдейты (<label style="color: #000000">{$global_updates_count_info.0}</label>)</a>{else}
<select size="1" style="width: 170px" name="ischlist" id="ischlist" onchange="DoGoToTypeLocation(this)">
 <option value="0" style="color: #0000FF">Все апдейты ({$global_updates_count_info.0})</option>
 <option value="1"{if $smarty.get.etype == '1'} selected="selected"{/if}>Яндекс ТиЦ ({$global_updates_count_info.1})</option>
 <option value="2"{if $smarty.get.etype == '2'} selected="selected"{/if}>Яндекс поиск ({$global_updates_count_info.2})</option>
 <option value="3"{if $smarty.get.etype == '3'} selected="selected"{/if}>Яндекс каталог ({$global_updates_count_info.3})</option>
...
{else}
 ...
 <form method="post" name="updatesformadd" id="updatesformadd" onsubmit="return PrepereSend(this)">
  ...
  <select size="1" style="width: 320px" name="updtype" id="updtype">
   <option value="1"{if $smarty.post.updtype == '1'} selected="selected"{/if}>Яндекс ТиЦ</option>
   <option value="2"{if $smarty.post.updtype == '2'} selected="selected"{/if}>Яндекс поиск</option>
   <option value="3"{if $smarty.post.updtype == '3'} selected="selected"{/if}>Яндекс каталог</option>
