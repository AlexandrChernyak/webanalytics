 ...
 <table width="100%" cellpadding="0" cellspacing="0" border="0">
   ...
   {if $adm_object->GetResult('data.source')}
	{foreach from=$adm_object->GetResult('data.source') item=val name=val}
	 ...
	 <td class="sth1" valign="top" align="center" style="padding-top: 4px; border-right: 1px solid #E4D9CB;" width="130px" onclick="$('#chid{$smarty.foreach.val.index}').click()">
	  {$val.datecreate}	  
	 </td>
...
{else}
 ...
 <form method="post" name="addnewlink" id="addnewlink" onsubmit="return PrepereSent(this)">
  ...
  Пример ссылки:<br />
  <u>http://site.com/?username=%s&sessionid=%s</u> и т.д</div>
  <div class="typelabel">
