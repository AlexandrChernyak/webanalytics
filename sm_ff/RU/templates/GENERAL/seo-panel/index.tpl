...
{elseif 1==1}
 <div>Используйте раздел панели оптимизатора в теме `Без оформления`</div>
{else}
 ...
 <script type="text/javascript" src="{$smarty.const.W_SITEPATH}css/panel/process.lib.js"></script>
 ...
 {if $PANEL_CONTROL->manageID}
  <div style="margin: 0 2px 20px 20px">
    ...
    ID #{$PANEL_CONTROL->manageID}, (пользователь: 
    ...
    <label style="margin-left: 6px"><a href="{$smarty.const.W_SITEPATH}panel/" style="font-size: 95%">Войти в <strong>мою</strong> панель!</a></label>
    ...
    <div class="divblocked" id="sectioninfo"><a href="javascript:">Все сайты</a></div>
	 ...
	 <td valign="center" align="right" width="150px" style="padding-right: 6px; white-space: nowrap;//width: 250px"> 
	  ...
	  <span style="margin-left: 4px">
	    ...
	    <option value="0"{if !$PANEL_CONTROL->GetResult('sections.selected')} selected="selected"{/if} id="_section_0">Все сайты</option>
 ...
 <div class="panelbuttomline" id="panelbuttomlineid">
  ...
  <span sectionidattr="0" class="{if !$PANEL_CONTROL->GetResult('sections.selected')}sectionbutton_selected{else}sectionbutton{/if}" id="section_0" onclick="SelectTabActive(this, '0', false)">Все сайты (<label id="sitecount_0">{$PANEL_CONTROL->GetResult('sections.allcount')}</label>)</span>
  {foreach from=$PANEL_CONTROL->GetResult('sections.data') item=val name=val}
...
<div class="bgnoregplqw"><img src="{$smarty.const.W_SITEPATH}css/panel/img/bgnoregimage.png" width="900px"></div>
{/if}