...
{if $PANEL_CONTROL->GetResult('params')}
 ...
 <td align="center" valign="center" width="22px">
  <a href="javascript:" title="Просмотр скриншота" onclick="previewImageURL('{$PANEL_CONTROL->GetResult('urllineinfo.iditem')}')"><img src="http://favicon.yandex.net/favicon/{$PANEL_CONTROL->line_obj->GetURL()}" width="16" height="16" align='absmiddle' alt="?"></a>
 </td> 
