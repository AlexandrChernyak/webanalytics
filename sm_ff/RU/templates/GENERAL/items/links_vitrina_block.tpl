{* блок витрины ссылок *}
<!-- vitrina links begin -->
<div class="apdates_title"><a href="{$smarty.const.W_SITEPATH}vitrinalinks/" class="upd_title">Витрина ссылок</a>
<span style="margin-left: 10px">[<a href="{$smarty.const.W_SITEPATH}vitrinalinks/new=1" class="restpsw" style="margin: 0px 2px 0 2px">Добавить</a>]</span></div> 
