...
<table width="96%" cellpadding="0" cellspacing="0" border="0" id="tableresultsourceid">
 ...
 <thead>	
 <tr>
  <th class="h_th1" valign="center" align="left" width="50%">
  <label style="margin-left: 4px;">Оригинальный</label><label class="bgshort">&nbsp;</label>
  </th>	
  <th class="h_td2" valign="center" align="left" width="50%">
  <label style="margin-left: 4px;">Закодированный</label><label class="bgshort">&nbsp;</label>
  </th>
 </tr>   	
 </thead>
 
 <tbody>{include file="tools/punycodeconv/tpl_punycodeconv_t_r_add_row.tpl"}</tbody>
