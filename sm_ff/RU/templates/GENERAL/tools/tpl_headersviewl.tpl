...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  Данный инструмент поможет Вам выполнить просмотр заголовков ответа сервера на запрос выбранных сайтов (URL).
  {/if}
 ...
 <script type="text/javascript">  
  ...
  function UpdateAdditionalObjects(disabled) { $('#followredirect').attr('disabled', disabled); }
  function ActionProcessStart() {
   var ch = document.getElementById('followredirect');
   var query = (ch && ch.checked) ? '&followredirect=1' : '';
...
<div class="typelabel">
   ...
   <input type="checkbox" name="followredirect" id="followredirect"><label for="followredirect" style="cursor: pointer"> Обходить редиректы</label>
</div>
