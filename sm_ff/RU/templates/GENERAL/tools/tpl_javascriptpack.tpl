...
<div style="margin-top: 5px">
 ...
 Данный инструмент поможет Вам выполнить упаковку кода javascript (сжатие кода).
 {/if}
 ...
 <form method="post" name="tollform" id="toolform" onsubmit="return PrepereToSend(this)">
  <div class="typelabel"><label id="red">*</label> Код JavaScript</div>
  <div class="typelabel"> 
  ...
  <textarea class="int_text" style="height: 250px; width: 96%" name="source" id="source">{$CONTROL_OBJ->GetPostElement('source', 'doactiontool')}</textarea>
   ...
   <div class="typelabel"> Кодирование:</div>
   <div class="typelabel">
	...
	<input type="checkbox" {if $smarty.post.doactiontool != 'do' || $CONTROL_OBJ->CheckPostValue('fast_decode')}checked="checked" {/if}style="cursor: pointer" name="fast_decode" id="fast_decode"><label for="fast_decode" style="cursor: pointer">&nbsp;Быстрая распаковка</label>
	</span>
	
	<span style="margin-left: 6px">
	<input type="checkbox" {if $CONTROL_OBJ->CheckPostValue('special_char')}checked="checked" {/if}style="cursor: pointer" name="special_char" id="special_char"><label for="special_char" style="cursor: pointer">&nbsp;Спец. символы</label>
	</span>
    ...
    <div style="margin-top: 12px; width: 95%; padding-left: 6px" id="block1">
     ...
     <div style="margin-top: 10px">
      ...
      <tr onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">	 
	   ...
	   <td class="sth1" valign="center" align="left" style="padding-left: 8px"> 
	    {$tool_object->GetResult('time')} сек
	   </td>
      </tr>
     ...
     <div class="typelabel">
      <input type="button" value="&nbsp;Распаковать&nbsp;" onclick="decode()" class="butt" name="rb" id="rb">
     </div>
