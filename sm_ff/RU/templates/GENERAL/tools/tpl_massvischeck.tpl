...
<div style="margin-top: 5px">
 <div style="margin-bottom: 12px">
  ...
  Данный инструмент поможет Вам выполнить проверку значения посещаемости ресурса по данным <noindex><a rel="nofollow" target="_blank" href="http://liveinternet.ru">LiveInternet</a></noindex> за сутки.
  {/if}
...
<div class="typelabel">
   ...
   <input type="checkbox" style="cursor: pointer" checked="checked" name="withimage" id="withimage"><label for="withimage" style="cursor: pointer">&nbsp;Отображать изображением</label>
   </span>
</div>
