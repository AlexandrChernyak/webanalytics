...
*}
 ...
 <div style="margin-top: 18px; border-bottom: 1px solid #969696; padding-bottom: 5px; width: 96%"><b>История показателей</b><label style="color: #000000; margin-left: 6px">[
 <a style="font-size: 95%" href="javascript:" onclick="ShHdBlElement(this, 'blockidqw{$block_ident}')">Скрыть</a> ]</label>
 </div>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function() {
	 $('#'+sourceident).html(
	  ...
	  '<img src="'+globalpatht+'img/items/ajax-loader.gif" border="0">' +
	  '</div>'
	 );	 
