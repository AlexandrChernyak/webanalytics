...
<tr onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">
 ...
 <td class="sth1" valign="center" align="left" style="border-left: 1px solid #E4D9CB; width: 200px">
  <label style="margin-left: 4px">  
   {$tool_object->CorrectURLLink($tool_object->GetResultValue('link'), 50)}&nbsp;<a title="Перейти на сайт (откроется в новом окне)" href="{$tool_object->CorrectLinkToProtocol($tool_object->GetResultValue('link'))}" target="_blank"><img src="{$smarty.const.W_SITEPATH}img/items/target_link.png"></a>  
  </label>	    
 </td>
 ...
 <td class="sth1" valign="center" align="right" style="border-right: 1px solid #E4D9CB">
