...
<div style="margin-top: 8px">
 ...
 <style type="text/css">
  ...
  .h_td2x { border-right: 1px solid #E4D9CB; border-left: none; }
  .btn_nx { border: 1px solid #E4D9CB; border-top: none; height: 25px; margin-top: 4px; }
  .sth1x { border-bottom: 1px solid #E4D9CB; height: 25px; border-top: none; }	
 </style>
 ...
 {/literal} 
 <div>{if !$descriptrecords}Всего проверено сайтов:{else}{$descriptrecords}{/if} <b>{$tool_object->GetHistoryData('', 'recordscount')}</b></div>
  ...
  <table width="{if !$tablewidth}100%{else}{$tablewidth}{/if}" cellpadding="0" cellspacing="0" border="0">  
    ...
    {foreach from=$tool_object->GetHistoryData('', 'source') item=val name=val}
     <tr onmouseover="DoHiglx(this, 1)" onmouseout="DoHiglx(this, 0)">      
      <td class="sth1x" valign="center" align="left" style="border-left: 1px solid #E4D9CB; padding-left: 4px">
      ...
      <td class="sth1x" valign="center" align="right" width="130px" style="border-right: 1px solid #E4D9CB; padding-right: 4px">
       {$val.datecreat}
      </td>    
     </tr>  
    {/foreach}
