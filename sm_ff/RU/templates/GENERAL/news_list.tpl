 ...
 {else}
  ...
  {if $global_data_list_info.info}
   ...
   <div style="text-align: right; margin-bottom: 6px; padding-right: 3px;">
    <a title="RSS канал комментариев" href="{$smarty.const.W_SITEPATH}rss/1/{$global_data_list_info.info.iditem}" target="_blank"><img src="{$smarty.const.W_SITEPATH}img/ico/general/feed.png" alt="rss" border="0" /></a>
   </div>
   ...
   Дата добавления: {$global_data_list_info.info.datecreate}, просмотров: {$global_data_list_info.info.newlooks}
   </div>
   <div style="margin-top: 8px">{include file="items/add_bookmarcks_block.tpl"}</div>
   
   {if $global_data_list_info.commentsdata}
   <div style="margin-top: 16px">
    <div id="comments" style="">Комментарии: <b>{$global_data_list_info.commentscount}</b></div>
  ...
  {else}
   ...
   {if $global_data_list_info.selectsection}
    ...
    <div style="margin-top: 10px; padding: 4px" onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">
     ...
     <tr>
	  ...
	  <td valign="top" align="left">
	   <div><b><a href="{$smarty.const.W_SITEPATH}news/1/">Новости сайта</a></b></div>
    ...
    <div style="margin-top: 10px; padding: 4px" onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">
     ...
     <tr>
	  ...
	  <td valign="top" align="left">
	   <div><b><a href="{$smarty.const.W_SITEPATH}news/2/">Новости интернета</a></b></div>
	   <div style="margin-top: 4px; font-size: 95%; color: #808080">
	...
	{else}
     ...
     <div style="text-align: right; margin-bottom: 6px; padding-right: 3px;">
      <a title="RSS канал" href="{$smarty.const.W_SITEPATH}rss/1/{$CONTROL_OBJ->CorrectSymplyString($smarty.get.identway)}" target="_blank"><img src="{$smarty.const.W_SITEPATH}img/ico/general/feed.png" alt="rss" border="0" /></a>
     </div>
     ...
     <div style="margin-top: 10px; padding: 4px" onmouseover="DoHigl(this, 1)" onmouseout="DoHigl(this, 0)">
      ...
      <tr>
	   ...
	   <td valign="top" align="left">
	    <div><b><a href="{$smarty.const.W_SITEPATH}{$val.opt.pathobjects}/{$val.data.iditem}/">{$val.data.sname}</a></b><label style="padding-left: 6px; font-size: 95%; color: #969696"><em>(Содержит: {$CONTROL_OBJ->GetPublicNewsCount($val.data.iditem)})</em></label></div>
	    <div style="margin-top: 4px; font-size: 95%; color: #808080">
   ...
   {else}
    ...
    <span style="width: 100%">
     ...
     <div style="text-align: right; margin-bottom: 6px; padding-right: 3px;">
      <a title="RSS канал" href="{$smarty.const.W_SITEPATH}rss/1/{$CONTROL_OBJ->CorrectSymplyString($smarty.get.identway)}/{$CONTROL_OBJ->CorrectSymplyString($smarty.get.ntype)}" target="_blank"><img src="{$smarty.const.W_SITEPATH}img/ico/general/feed.png" alt="rss" border="0" /></a>
     </div>
	  ...
	  <tr>
	   ...
	   <td valign="top" align="left">
		...
		{$CONTROL_OBJ->DateTimeToSpecialFormat($val.datecreate)}  Просмотров: {$val.newlooks}, комментариев: {$CONTROL_OBJ->GetCommentCountForElement($smarty.get.ntype, $val.iditem)} 
		</div>
