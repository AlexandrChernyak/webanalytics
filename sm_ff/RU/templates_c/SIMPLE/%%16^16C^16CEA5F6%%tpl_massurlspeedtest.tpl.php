<?php /* Smarty version 2.6.26, created on 2016-05-15 09:02:46
         compiled from tools/tpl_massurlspeedtest.tpl */ ?>
...
<?php else: ?>
  Данный инструмент поможет Вам выполнить проверку скорости ответа сайта на запрос посетителя.
  <?php endif; ?>
...
<?php echo @W_SITEPATH; ?>
<?php echo '\';
  var PathRequstAction = PathHost + \'tools/'; ?>
