<?php /* Smarty version 2.6.26, created on 2016-05-15 09:03:04
         compiled from tools/massurlspeedtest/tpl_massurlspeedtest_t_r.tpl */ ?>
<div>
<?php echo '
 <style type="text/css">
  .h_th1, .h_td, .h_td2 { 
...
<table width="96%" cellpadding="0" cellspacing="0" border="0" id="tableresultsourceid">
 ...
 <tr>
  ...
  <label style="margin-right: 4px;">Скорость</label><label class="bgshort">&nbsp;</label>
  </th>
 </tr>   	
 </thead>
 
 <tbody><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "tools/massurlspeedtest/tpl_massurlspeedtest_t_r_add_row.tpl", 'smarty_include_vars' => array()));
